...
> Traducido de [`MAILBOX_SETUP.md`](../MAILBOX_SETUP.md), que es la fuente de verdad. Si algo aquí
> contradice al original en español (MX), **manda el español**, y avísanos, porque
