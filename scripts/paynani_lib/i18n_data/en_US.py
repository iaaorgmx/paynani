"""
en-US, traducido de es-MX. Puerto 1:1 de webapp/i18n/en-US.php —
...
STRINGS = {
    ...
    'page.lead': 'Seven details from your mail provider, plus your own name and email for the authorized contact list. Everything stays on this computer. This page is not reachable from the internet.',
    'lang.label': 'Language',
    'lang.apply': 'Change',
    'saved.h1': 'Done',
    ...
    'saved.runtime_generic_1': 'Write <code>done</code> to the agent so it can continue the install.',
    'saved.runtime_generic_2': 'The agent runs the final checks and tells you what was installed outside the repository.',
    'saved.runtime_openclaw_1': 'Write <code>done</code> to the agent so it can install the services and the OpenClaw rule.',
    'saved.runtime_openclaw_2': 'The agent checks the listener, the dispatcher, and that OpenClaw has the rule that recognizes <code>, roster]</code>.',
    'saved.runtime_hermes_1': 'Write <code>done</code> to the agent so it can install the services and finish the Hermes setup.',
    'saved.runtime_hermes_2': 'The agent validates the approved Hermes routes and then runs the final checks.',
    'saved.runtime_claudecode_1': 'Write <code>done</code> to the agent so it can install the services and register the Claude Code hook.',
    'saved.runtime_claudecode_2': 'After install, restart your open Claude Code sessions so they load the hook.',
    'saved.runtime_codex_1': 'Write <code>done</code> to the agent so it can install the services and register the Codex hook.',
    'saved.runtime_codex_2': 'After install, restart your open Codex sessions so they read the pending spool.',
    'saved.runtime_opencode_1': 'Write <code>done</code> to the agent here in OpenCode; OpenCode does not notify it by itself when you save this page.',
    'saved.runtime_opencode_2': 'When the agent finishes, close and reopen OpenCode so it loads the paynani plugin.',
    ...
    'saved.roster_failed': "The agent's account was saved, but you could not be added to <code>roster.md</code>: {reason} Let the agent know: it checks <code>roster.md</code> at step 7 of <code>AGENTS.md</code>.",
    'saved.checklist_h2': 'Install checklist',
    'saved.checklist_p': 'These rows are recalculated from files and the selected runtime. They show what is already true and what the agent still has to run.',
    'saved.check_status_ok': 'ok',
    'saved.check_status_todo': 'todo',
    'saved.check_status_optional': 'optional',
    'saved.check_doc': 'See {doc}.',
    'saved.check_credentials_title': 'Mailbox credentials saved',
    'saved.check_credentials_detail': 'The mail account was verified and written with restricted permissions.',
    'saved.check_roster_title': 'Human contact in roster.md',
    'saved.check_roster_detail': 'The person filling this form is authorized as a Human contact.',
    'saved.check_notifiers_title': 'Coordination notifiers declared',
    'saved.check_notifiers_detail': 'Needed only when GitHub, Jira or another platform sends mail on behalf of teammates.',
    'saved.check_services_title': 'Listener and dispatcher installed',
    'saved.check_services_detail': 'The agent installs or upgrades the supervised services after this page closes.',
    'saved.check_runtime_title': 'Runtime hook or plugin installed',
    'saved.check_runtime_detail': 'The selected runtime needs its delivery hook, plugin or route.',
    'saved.check_health_title': 'Required health checks passed',
    'saved.check_health_detail': 'The agent must run the required checks before reporting the install complete.',
    'saved.check_mail_title': 'Optional real-mail test',
    'saved.check_mail_detail': 'A human can send a roster message after the required checks pass.',
    'saved.summary_h2': 'Copy-safe summary',
    'saved.summary_p': 'This contains paths, masked account, runtime and next steps. It does not include the password or any secret value.',
    'saved.summary_copy': 'Copy summary',
    ...
    'form.roster_legend': 'Who you are',
    'form.roster_name_label': 'Your name',
    'form.roster_name_ph': 'Jane Doe',
    'form.roster_name_hint': 'How the agent will recognize you in the mail you send it.',
    'form.roster_email_label': 'Your email address',
    'form.roster_email_ph': 'you@example.com',
    'form.roster_email_hint': "The agent only follows instructions arriving from this address. Not the agent's own account — yours.",
    ...
    'v.roster_name_missing': 'Your name is needed for the authorized contact list.',
    'v.roster_name_oneline': 'Your name has to fit on a single line.',
    'v.roster_email_missing': 'Your email is needed for the authorized contact list.',
    'v.roster_email_bad': 'That does not look like an email address.',
    'v.roster_email_same_as_account': "That is the agent's own account. Enter your own address, not its.",
