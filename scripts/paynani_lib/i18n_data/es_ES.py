...
STRINGS = {
    ...
    'saved.roster_failed': 'La cuenta del agente ha quedado guardada, pero no se ha podido agregarte a <code>roster.md</code>: {reason} Agrégate a mano con <code>paynani roster add</code>.',
