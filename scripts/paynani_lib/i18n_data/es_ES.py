"""
es-ES, traducido de es-MX. Puerto 1:1 de webapp/i18n/es-ES.php —
mismas claves, mismo texto, sin retraducir.
"""

STRINGS = {
    'page.title': 'paynani: configuración del buzón',
    'page.h1': 'Dale un buzón al agente',
    'page.lead': 'Siete datos de tu proveedor de correo, y tu nombre y correo para la lista de contactos autorizados. Todo se queda en este ordenador. Esta página no es accesible desde internet.',
    'lang.label': 'Idioma',
    'lang.apply': 'Cambiar',
    'saved.h1': 'Listo',
    ...
    'saved.runtime_generic_1': 'Escribe <code>listo</code> al agente para que continúe con la instalación.',
    'saved.runtime_generic_2': 'El agente ejecuta las comprobaciones finales y te dice qué se instaló fuera del repositorio.',
    'saved.runtime_openclaw_1': 'Escribe <code>listo</code> al agente para que instale los servicios y la regla de OpenClaw.',
    'saved.runtime_openclaw_2': 'El agente comprueba el listener, el dispatcher y que OpenClaw tenga la regla que reconoce <code>, roster]</code>.',
    'saved.runtime_hermes_1': 'Escribe <code>listo</code> al agente para que instale los servicios y termine la configuración de Hermes.',
    'saved.runtime_hermes_2': 'El agente valida las rutas aprobadas de Hermes y luego ejecuta las comprobaciones finales.',
    'saved.runtime_claudecode_1': 'Escribe <code>listo</code> al agente para que instale los servicios y registre el hook de Claude Code.',
    'saved.runtime_claudecode_2': 'Después de instalar, reinicia tus sesiones abiertas de Claude Code para que carguen el hook.',
    'saved.runtime_codex_1': 'Escribe <code>listo</code> al agente para que instale los servicios y registre el hook de Codex.',
    'saved.runtime_codex_2': 'Después de instalar, reinicia tus sesiones abiertas de Codex para que lean el spool pendiente.',
    'saved.runtime_opencode_1': 'Escribe <code>listo</code> al agente aquí en OpenCode; OpenCode no le avisa por sí solo cuando guardas esta página.',
    'saved.runtime_opencode_2': 'Cuando el agente termine, cierra y vuelve a abrir OpenCode para que cargue el plugin de paynani.',
    'saved.forgot': 'Esta página ya ha olvidado la contraseña. Volver a abrirla no la muestra otra vez.',
    'saved.roster_added': 'También has quedado agregado a la lista de contactos autorizados (<code>roster.md</code>).',
    'saved.roster_already': 'Tu correo ya estaba en la lista de contactos autorizados (<code>roster.md</code>); no se ha tocado.',
    'saved.roster_failed': 'La cuenta del agente ha quedado guardada, pero no se ha podido añadirte a <code>roster.md</code>: {reason} Avisa al agente: él revisa <code>roster.md</code> en el paso 7 de <code>AGENTS.md</code>.',
    'saved.checklist_h2': 'Lista de comprobación de instalación',
    'saved.checklist_p': 'Estas filas se recalculan desde los archivos y el runtime elegido. Muestran qué ya es cierto y qué debe ejecutar todavía el agente.',
    'saved.check_status_ok': 'ok',
    'saved.check_status_todo': 'pendiente',
    'saved.check_status_optional': 'opcional',
    'saved.check_doc': 'Ver {doc}.',
    'saved.check_credentials_title': 'Credenciales de correo guardadas',
    'saved.check_credentials_detail': 'La cuenta de correo fue verificada y escrita con permisos restringidos.',
    'saved.check_roster_title': 'Contacto humano en roster.md',
    'saved.check_roster_detail': 'La persona que ha rellenado este formulario queda autorizada como contacto Human.',
    'saved.check_notifiers_title': 'Notificadores de coordinación declarados',
    'saved.check_notifiers_detail': 'Sólo hace falta cuando GitHub, Jira u otra plataforma envía correo en nombre del equipo.',
    'saved.check_services_title': 'Listener y dispatcher instalados',
    'saved.check_services_detail': 'El agente instala o actualiza los servicios supervisados después de cerrar esta página.',
    'saved.check_runtime_title': 'Hook o plugin del runtime instalado',
    'saved.check_runtime_detail': 'El runtime elegido necesita su hook, plugin o ruta de entrega.',
    'saved.check_health_title': 'Comprobaciones requeridas en verde',
    'saved.check_health_detail': 'El agente debe ejecutar las comprobaciones requeridas antes de informar de que la instalación está completa.',
    'saved.check_mail_title': 'Prueba opcional con correo real',
    'saved.check_mail_detail': 'Un humano puede enviar un correo roster después de que pasen las comprobaciones requeridas.',
    'saved.summary_h2': 'Resumen seguro para copiar',
    'saved.summary_p': 'Incluye rutas, cuenta enmascarada, runtime y próximos pasos. No incluye la contraseña ni ningún secreto.',
    'saved.summary_copy': 'Copiar resumen',
    ...
    'form.roster_legend': 'Quién eres tú',
    'form.roster_name_label': 'Tu nombre',
    'form.roster_name_ph': 'María Pérez',
    'form.roster_name_hint': 'Así te va a reconocer el agente en los correos que le mandes.',
    'form.roster_email_label': 'Tu correo electrónico',
    'form.roster_email_ph': 'tu@correo.example',
    'form.roster_email_hint': 'El agente solo obedece instrucciones que lleguen desde esta dirección. No es la cuenta del agente: es la tuya.',
    ...
    'v.roster_name_missing': 'Hace falta tu nombre para la lista de contactos autorizados.',
    'v.roster_name_oneline': 'Tu nombre tiene que caber en una sola línea.',
    'v.roster_email_missing': 'Hace falta tu correo para la lista de contactos autorizados.',
    'v.roster_email_bad': 'Eso no parece una dirección de correo.',
    'v.roster_email_same_as_account': 'Esa es la cuenta del agente. Pon tu propio correo, no el suyo.',
    ...
    'g.token_2': 'Pide al agente que ejecute paynani onboard otra vez y te mande el enlace nuevo.',
