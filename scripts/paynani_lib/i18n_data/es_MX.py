...
STRINGS = {
    ...
    'saved.roster_failed': 'La cuenta del agente quedó guardada, pero no se pudo agregarte a <code>roster.md</code>: {reason} Agrégate a mano con <code>paynani roster add</code>.',
