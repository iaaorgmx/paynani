"""
Español (MX). El idioma fuente: todos los demás catálogos se traducen de
este, y una clave que falte en otro cae aquí.
"""

STRINGS = {
    'page.title': 'paynani: configuración del buzón',
    'page.h1': 'Dale un buzón al agente',
    'page.lead': 'Siete datos de tu proveedor de correo, y tu nombre y correo para la lista de contactos autorizados. Todo se queda en esta computadora. Esta página no es accesible desde internet.',
    'lang.label': 'Idioma',
    'lang.apply': 'Cambiar',
    'saved.h1': 'Listo',
    ...
    'saved.runtime_generic_1': 'Escríbele <code>listo</code> al agente para que siga con la instalación.',
    'saved.runtime_generic_2': 'El agente corre las verificaciones finales y te dice qué quedó instalado fuera del repositorio.',
    'saved.runtime_openclaw_1': 'Escríbele <code>listo</code> al agente para que instale los servicios y la regla de OpenClaw.',
    'saved.runtime_openclaw_2': 'El agente verifica el listener, el dispatcher y que OpenClaw tenga la regla que reconoce <code>, roster]</code>.',
    'saved.runtime_hermes_1': 'Escríbele <code>listo</code> al agente para que instale los servicios y termine la configuración de Hermes.',
    'saved.runtime_hermes_2': 'El agente valida las rutas aprobadas de Hermes y después corre las verificaciones finales.',
    'saved.runtime_claudecode_1': 'Escríbele <code>listo</code> al agente para que instale los servicios y registre el hook de Claude Code.',
    'saved.runtime_claudecode_2': 'Después de instalar, reinicia tus sesiones abiertas de Claude Code para que carguen el hook.',
    'saved.runtime_codex_1': 'Escríbele <code>listo</code> al agente para que instale los servicios y registre el hook de Codex.',
    'saved.runtime_codex_2': 'Después de instalar, reinicia tus sesiones abiertas de Codex para que lean el spool pendiente.',
    'saved.runtime_opencode_1': 'Escríbele <code>listo</code> al agente aquí en OpenCode; OpenCode no le avisa solo cuando guardas esta página.',
    ...
    'saved.checklist_h2': 'Checklist de instalación',
    'saved.checklist_p': 'Estas filas se recalculan desde los archivos y el runtime elegido. Muestran qué ya es cierto y qué debe correr todavía el agente.',
    ...
    'saved.check_roster_detail': 'La persona que llenó este formulario queda autorizada como contacto Human.',
    ...
    'saved.check_health_title': 'Verificaciones requeridas en verde',
    'saved.check_health_detail': 'El agente debe correr las verificaciones requeridas antes de reportar la instalación completa.',
    'saved.check_mail_title': 'Prueba opcional con correo real',
    'saved.check_mail_detail': 'Un humano puede mandar un correo roster después de que pasen las verificaciones requeridas.',
