...
STRINGS = {
    ...
    'saved.roster_failed': "Le compte de l'agent a été enregistré, mais vous n'avez pas pu être ajouté à <code>roster.md</code> : {reason} Ajoutez-vous à la main avec <code>paynani roster add</code>.",
