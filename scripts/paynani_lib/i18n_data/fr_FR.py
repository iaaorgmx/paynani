"""
fr-FR, traducido de es-MX. Puerto 1:1 de webapp/i18n/fr-FR.php —
...
STRINGS = {
    ...
    'page.lead': "Sept informations venant de votre fournisseur de messagerie, plus votre nom et votre adresse électronique pour la liste des contacts autorisés. Tout reste sur cet ordinateur. Cette page n'est pas accessible depuis internet.",
    'lang.label': 'Langue',
    'lang.apply': 'Changer',
    'saved.h1': "C'est fait",
    ...
    'saved.runtime_generic_1': "Écrivez <code>prêt</code> à l'agent pour qu'il continue l'installation.",
    'saved.runtime_generic_2': "L'agent exécute les vérifications finales et vous dit ce qui a été installé hors du dépôt.",
    'saved.runtime_openclaw_1': "Écrivez <code>prêt</code> à l'agent pour qu'il installe les services et la règle OpenClaw.",
    'saved.runtime_openclaw_2': "L'agent vérifie le listener, le dispatcher et la règle OpenClaw qui reconnaît <code>, roster]</code>.",
    'saved.runtime_hermes_1': "Écrivez <code>prêt</code> à l'agent pour qu'il installe les services et termine la configuration Hermes.",
    'saved.runtime_hermes_2': "L'agent valide les routes Hermes approuvées puis exécute les vérifications finales.",
    'saved.runtime_claudecode_1': "Écrivez <code>prêt</code> à l'agent pour qu'il installe les services et enregistre le hook Claude Code.",
    'saved.runtime_claudecode_2': "Après l'installation, redémarrez vos sessions Claude Code ouvertes pour charger le hook.",
    'saved.runtime_codex_1': "Écrivez <code>prêt</code> à l'agent pour qu'il installe les services et enregistre le hook Codex.",
    'saved.runtime_codex_2': "Après l'installation, redémarrez vos sessions Codex ouvertes pour lire le spool en attente.",
    'saved.runtime_opencode_1': "Écrivez <code>prêt</code> à l'agent ici dans OpenCode ; OpenCode ne le prévient pas tout seul quand vous enregistrez cette page.",
    'saved.runtime_opencode_2': "Quand l'agent a terminé, fermez puis rouvrez OpenCode pour charger le plugin paynani.",
    ...
    'saved.checklist_h2': "Liste de vérification de l'installation",
    'saved.checklist_p': "Ces lignes sont recalculées depuis les fichiers et le runtime choisi. Elles indiquent ce qui est déjà vrai et ce que l'agent doit encore exécuter.",
    'saved.check_status_ok': 'ok',
    'saved.check_status_todo': 'à faire',
    'saved.check_status_optional': 'facultatif',
    'saved.check_doc': 'Voir {doc}.',
    'saved.check_credentials_title': 'Identifiants de messagerie enregistrés',
    'saved.check_credentials_detail': 'Le compte de messagerie a été vérifié et écrit avec des permissions restreintes.',
    'saved.check_roster_title': 'Contact humain dans roster.md',
    'saved.check_roster_detail': 'La personne qui a rempli ce formulaire est autorisée comme contact Human.',
    'saved.check_notifiers_title': 'Notificateurs de coordination déclarés',
    'saved.check_notifiers_detail': "Nécessaire seulement si GitHub, Jira ou une autre plateforme envoie du courrier au nom de l'équipe.",
    'saved.check_services_title': 'Listener et dispatcher installés',
    'saved.check_services_detail': "L'agent installe ou met à jour les services supervisés après la fermeture de cette page.",
    'saved.check_runtime_title': 'Hook ou plugin du runtime installé',
    'saved.check_runtime_detail': 'Le runtime choisi a besoin de son hook, plugin ou route de livraison.',
    'saved.check_health_title': 'Vérifications obligatoires réussies',
    'saved.check_health_detail': "L'agent doit exécuter les vérifications obligatoires avant d'annoncer que l'installation est terminée.",
    'saved.check_mail_title': 'Test facultatif avec un vrai courrier',
    'saved.check_mail_detail': 'Un humain peut envoyer un courrier roster après la réussite des vérifications obligatoires.',
    'saved.summary_h2': 'Résumé sûr à copier',
    'saved.summary_p': "Il contient les chemins, le compte masqué, le runtime et les prochaines étapes. Il n'inclut ni mot de passe ni secret.",
    'saved.summary_copy': 'Copier le résumé',
    ...
    'form.roster_legend': 'Qui vous êtes',
    'form.roster_name_label': 'Votre nom',
    'form.roster_name_ph': 'Jeanne Dupont',
    'form.roster_name_hint': "Comment l'agent vous reconnaîtra dans les messages que vous lui envoyez.",
    'form.roster_email_label': 'Votre adresse électronique',
    'form.roster_email_ph': 'vous@exemple.example',
    'form.roster_email_hint': "L'agent ne suit que les instructions venant de cette adresse. Pas le compte de l'agent : le vôtre.",
    ...
    'v.roster_name_missing': 'Votre nom est nécessaire pour la liste des contacts autorisés.',
    'v.roster_name_oneline': 'Votre nom doit tenir sur une seule ligne.',
    'v.roster_email_missing': 'Votre adresse électronique est nécessaire pour la liste des contacts autorisés.',
    'v.roster_email_bad': 'Cela ne ressemble pas à une adresse électronique.',
    'v.roster_email_same_as_account': "C'est le compte de l'agent. Indiquez votre propre adresse, pas la sienne.",
