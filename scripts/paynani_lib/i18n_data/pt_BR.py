"""
pt-BR, traducido de es-MX. Puerto 1:1 de webapp/i18n/pt-BR.php —
...
STRINGS = {
    ...
    'page.lead': 'Sete dados do seu provedor de e-mail, além do seu nome e e-mail para a lista de contatos autorizados. Tudo fica neste computador. Esta página não é acessível pela internet.',
    'lang.label': 'Idioma',
    'lang.apply': 'Trocar',
    'saved.h1': 'Pronto',
    ...
    'saved.runtime_generic_1': 'Escreva <code>pronto</code> para o agente continuar a instalação.',
    'saved.runtime_generic_2': 'O agente roda as verificações finais e diz o que foi instalado fora do repositório.',
    'saved.runtime_openclaw_1': 'Escreva <code>pronto</code> para o agente instalar os serviços e a regra do OpenClaw.',
    'saved.runtime_openclaw_2': 'O agente verifica o listener, o dispatcher e se o OpenClaw tem a regra que reconhece <code>, roster]</code>.',
    'saved.runtime_hermes_1': 'Escreva <code>pronto</code> para o agente instalar os serviços e terminar a configuração do Hermes.',
    'saved.runtime_hermes_2': 'O agente valida as rotas aprovadas do Hermes e depois roda as verificações finais.',
    'saved.runtime_claudecode_1': 'Escreva <code>pronto</code> para o agente instalar os serviços e registrar o hook do Claude Code.',
    'saved.runtime_claudecode_2': 'Depois de instalar, reinicie suas sessões abertas do Claude Code para que carreguem o hook.',
    'saved.runtime_codex_1': 'Escreva <code>pronto</code> para o agente instalar os serviços e registrar o hook do Codex.',
    'saved.runtime_codex_2': 'Depois de instalar, reinicie suas sessões abertas do Codex para que leiam o spool pendente.',
    'saved.runtime_opencode_1': 'Escreva <code>pronto</code> para o agente aqui no OpenCode; o OpenCode não avisa sozinho quando você salva esta página.',
    'saved.runtime_opencode_2': 'Quando o agente terminar, feche e abra de novo o OpenCode para carregar o plugin do paynani.',
    'saved.forgot': 'Esta página já esqueceu a senha. Abrir de novo não mostra ela outra vez.',
    'saved.roster_added': 'Você também foi adicionado à lista de contatos autorizados (<code>roster.md</code>).',
    'saved.roster_already': 'Seu e-mail já estava na lista de contatos autorizados (<code>roster.md</code>); nada foi alterado.',
    'saved.roster_failed': 'A conta do agente ficou salva, mas não foi possível adicionar você ao <code>roster.md</code>: {reason} Avise o agente: ele confere o <code>roster.md</code> no passo 7 do <code>AGENTS.md</code>.',
    'saved.checklist_h2': 'Checklist de instalação',
    'saved.checklist_p': 'Estas linhas são recalculadas a partir dos arquivos e do runtime escolhido. Elas mostram o que já é verdade e o que o agente ainda precisa executar.',
    'saved.check_status_ok': 'ok',
    'saved.check_status_todo': 'pendente',
    'saved.check_status_optional': 'opcional',
    'saved.check_doc': 'Veja {doc}.',
    'saved.check_credentials_title': 'Credenciais de e-mail salvas',
    'saved.check_credentials_detail': 'A conta de e-mail foi verificada e escrita com permissões restritas.',
    'saved.check_roster_title': 'Contato humano no roster.md',
    'saved.check_roster_detail': 'A pessoa que preencheu este formulário fica autorizada como contato Human.',
    'saved.check_notifiers_title': 'Notificadores de coordenação declarados',
    'saved.check_notifiers_detail': 'Só é necessário quando GitHub, Jira ou outra plataforma envia e-mail em nome da equipe.',
    'saved.check_services_title': 'Listener e dispatcher instalados',
    'saved.check_services_detail': 'O agente instala ou atualiza os serviços supervisionados depois que esta página fechar.',
    'saved.check_runtime_title': 'Hook ou plugin do runtime instalado',
    'saved.check_runtime_detail': 'O runtime escolhido precisa do seu hook, plugin ou rota de entrega.',
    'saved.check_health_title': 'Verificações obrigatórias em verde',
    'saved.check_health_detail': 'O agente deve rodar as verificações obrigatórias antes de informar que a instalação está completa.',
    'saved.check_mail_title': 'Teste opcional com e-mail real',
    'saved.check_mail_detail': 'Um humano pode enviar um e-mail roster depois que as verificações obrigatórias passarem.',
    'saved.summary_h2': 'Resumo seguro para copiar',
    'saved.summary_p': 'Inclui caminhos, conta mascarada, runtime e próximos passos. Não inclui a senha nem nenhum segredo.',
    'saved.summary_copy': 'Copiar resumo',
    ...
    'form.roster_legend': 'Quem é você',
    'form.roster_name_label': 'Seu nome',
    'form.roster_name_ph': 'Maria Silva',
    'form.roster_name_hint': 'Assim o agente vai te reconhecer nos e-mails que você mandar para ele.',
    'form.roster_email_label': 'Seu e-mail',
    'form.roster_email_ph': 'voce@exemplo.example',
    'form.roster_email_hint': 'O agente só obedece instruções que chegam a partir deste endereço. Não é a conta do agente: é a sua.',
    ...
    'v.roster_name_missing': 'Falta seu nome para a lista de contatos autorizados.',
    'v.roster_name_oneline': 'Seu nome tem que caber numa única linha.',
    'v.roster_email_missing': 'Falta seu e-mail para a lista de contatos autorizados.',
    'v.roster_email_bad': 'Isso não parece um endereço de e-mail.',
    'v.roster_email_same_as_account': 'Essa é a conta do agente. Coloque o seu próprio e-mail, não o dele.',
    ...
    'g.token_2': 'Peça ao agente para rodar paynani onboard de novo e te mandar o link novo.',
