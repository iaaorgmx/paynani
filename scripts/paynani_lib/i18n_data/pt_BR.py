...
STRINGS = {
    ...
    'saved.roster_failed': 'A conta do agente ficou salva, mas não foi possível te adicionar a <code>roster.md</code>: {reason} Adicione-se à mão com <code>paynani roster add</code>.',
